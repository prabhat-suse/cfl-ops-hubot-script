...
(function() {
 ...
 // 2. Add chat UI with a toggle button
    ...
    chatContainer.innerHTML = `
        ...
        <div id="chatbox" style="display: none; width: 500px; height: 700px; border: 1px solid #ddd; background-color: #efefef; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); flex-direction: column; border-radius: 10px; font-family: 'SUSE', sans-serif; font-size: 18px;">
